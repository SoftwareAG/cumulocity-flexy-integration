...
WORK_DIR=$(pwd)
IMAGE_NAME=ewon-flexy-integration
TAG_NAME="latest"
DEPLOY_ADDRESS=https://devicecert-testtenant.eu-latest.cumulocity.com
DEPLOY_TENANT=t769416337
...
getApplicationId () {
	echo "=============== getApplicationId EXECUTING ================="
...
createApplication () {
	echo "=============== createApplication EXECUTING ================="
	body="{
